...
do
		...
		if [ -f ../files/currentconfig/ora_version.lis_$HOST ]
		then
		cat ../files/currentconfig/ora_version.lis_$HOST >> $FILES/html/ora_overview.html
		fi
		echo "
		</pre>
		</td>
		...
		<td width="60%">
		<pre> " >> $FILES/html/ora_overview.html
		if [ -f ../files/currentconfig/ora_otherversion.lis_$HOST ]
		then
		cat ../files/currentconfig/ora_otherversion.lis_$HOST >> $FILES/html/ora_overview.html
		fi
		echo "
		</pre>
		</td>
		...
		<td width="60%">
		<pre> " >> $FILES/html/ora_overview.html
		if [ -f ../files/currentconfig/ora_options.lis_$HOST ]
		then
		cat ../files/currentconfig/ora_options.lis_$HOST >> $FILES/html/ora_overview.html
		fi
		echo "
		</pre>
		</td>
		...
		<td width="60%">
		<pre> " >> $FILES/html/ora_overview.html
		if [ -f ../files/currentconfig/ora_registry.lis_$HOST ]
		then
		cat ../files/currentconfig/ora_registry.lis_$HOST >> $FILES/html/ora_overview.html
		fi
		echo "
		</pre>
		</td>
		...
		<td width="60%">
		<pre> " >> $FILES/html/ora_overview.html
		if [ -f ../files/currentconfig/ora_userpriv.lis_$HOST ]
		then
		cat ../files/currentconfig/ora_userpriv.lis_$HOST >> $FILES/html/ora_overview.html
		fi
		echo "
		</pre>
		</td>
		...
		if [ -f ../files/audit_results/ORACLE/ora_tablespace.lis_$HOST ]
		then
		cat ../files/audit_results/ORACLE/ora_tablespace.lis_$HOST >> $FILES/html/ora_health.html
		fi
		echo "
		</pre>
		</td>
		...
		<td width="60%">
		<pre> " >> $FILES/html/ora_health.html
		if [ -f ../files/audit_results/ORACLE/ora_segments.lis_$HOST ]
		then
		cat ../files/audit_results/ORACLE/ora_segments.lis_$HOST >> $FILES/html/ora_health.html
		fi
		echo "
		</pre>
		</td>
		...
		<td width="60%">
		<pre> " >> $FILES/html/ora_health.html
		if [ -f ../files/audit_results/ORACLE/ora_pgasessions.lis_$HOST ]
		then
		cat ../files/audit_results/ORACLE/ora_pgasessions.lis_$HOST >> $FILES/html/ora_health.html
		fi
		echo "
		</pre>
		</td>
